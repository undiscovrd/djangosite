...
urlpatterns = patterns('',
    ...
    url(r'^basicsite/deletepipeline/(\d+)/$', 'basicsite.views.deletePipeline'),
    ...
    url(r'^basicsite/removetrack/(\d+)/$', 'basicsite.views.removeTrack'),
    ...
    url(r'^basicsite/removetool/(\d+)/$', 'basicsite.views.removePipelineTool'),
    ...
    url(r'^basicsite/tools', 'basicsite.views.loadToolsPage'),
    ...
    url(r'^basicsite/toolcategories/collection', 'basicsite.views.loadCollectionToolsPage'),
    url(r'^basicsite/toolcategories/checkprocess', 'basicsite.views.loadCheckingProcessingToolsPage'),
    url(r'^basicsite/toolcategories/label', 'basicsite.views.loadLabelingToolsPage'),
    ...
    url(r'^basicsite/family/(\d+)/$', 'basicsite.views.loadToolFamilyPage'),
